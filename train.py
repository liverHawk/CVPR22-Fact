...
def get_command_line_parser():
    ...
    parser.add_argument(
        "-schedule", type=str, default="Step", choices=["Step", "Milestone", "Cosine"]
    )
    ...
    parser.add_argument(
        "-base_mode", type=str, default="ft_cos", choices=["ft_dot", "ft_cos"]
    ...
    parser.add_argument(
        "-no_eval",
        action="store_true",
        help="skip in-loop evaluation during training; run test.py afterwards for the main test run",
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="FACT-FSCIL", help="wandb project name"
    )
    parser.add_argument(
        "--wandb_entity", type=str, default=None, help="wandb entity (username or team)"
    )
    parser.add_argument(
        "--wandb_cm_freq",
        type=int,
